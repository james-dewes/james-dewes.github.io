...
In 2021 I joined Modo25 combining my data and development experience into a data engineering role where my main objective is to deskill data use through automation, making processes and systems as fast and intuitive as possible. 
...
- **SQL** - Database queries, data analysis, ETL processes
- **JavaScript** - Front-end development, web applications
- **PHP** - Web development (WordPress, custom applications)
...
### Areas of Expertise
- **Data Engineering** - ETL pipelines, data automation, data processing
- **Web Development** - Full-stack development, front-end and back-end
- **Data Analysis** - Reporting, analytics, data visualization
